...
export class adminController {
  ...
  public userSignUp = async (
    ...
    try {
      ...
      logger.error("Error in user sign in" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public listUserBookings = async (
    ...
    try {
      ...
      logger.error("Error in list User Bookings" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public deleteBookings = async (
    ...
    try {
      ...
      logger.error("Error in delete User Bookings" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public listSignUpUsers = async (
    ...
    try {
      ...
      logger.error("Error in list SignUp Users" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public listOverallAudit = async (
    ...
    try {
      ...
      logger.error("Error in listOverallAudit" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public reportPage = async (
    ...
    try {
      ...
      logger.error("Error in reportPage" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public approveGround = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.approveGroundV1(request.payload, decodedToken);
      ...
      logger.error("Error in approveGround" , error);
      return response
        .response({
          success: false,
          message:
  ...
  public ownerAudit = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.ownerAuditV1(request.payload, decodedToken);
      ...
      logger.error("Error in ownerAudit" , error);
      return response
        .response({
          success: false,
          message:
