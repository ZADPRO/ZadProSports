...
export class userController {
  ...
  public login = async (
    ...
    try {
      ...
      // }
      let entity;
      entity = await this.resolver.loginV1(
        request.payload
        // ,decodedToken
      );
  ...
  public userGroundBooking = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.userGroundBookingV1(
        request.payload,
        decodedToken
      );
  ...
  public listFilteredGrounds = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.listFilteredGroundsV1(
        request.payload,
        decodedToken
      );
  ...
  public listFreeGrounds = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.listFreeGroundsV1(
        request.payload,
        decodedToken
      );
  ...
  public listProfileData = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.listProfileDataV1(
        request.payload,
        decodedToken
      );
  ...
  public updateProfileData = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.updateProfileDataV1(
        request.payload,
        decodedToken
      );
  ...
  public forgotPassword = async (
    ...
    try {
      ...
      // }
      let entity;
      entity = await this.resolver.forgotPasswordV1(
        request.payload
        // ,decodedToken
      );
  ...
  public userBookingHistory = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.userBookingHistoryV1(
        request.payload,
        decodedToken
      );
  ...
  public userAuditPage = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.userAuditPageV1(
        request.payload,
        decodedToken
      );
  ...
  public getGrounds = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.getGroundsV1(request.payload, decodedToken);
      ...
      logger.error("Error in getGrounds", error);
      return response
        .response({
          success: false,
          message:
  ...
  public getUnavailableAddons = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info(`GET URL REQ => ${request.url.href}`);
    try {
      ...
      let entity;
      entity = await this.resolver.getUnavailableAddonsV1(
        request.payload,
        decodedToken
      );
      ...
      logger.error("Error in getUnavailableAddons", error);
      return response
        .response({
          success: false,
          message:
  ...
  public payConvertString = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.payConvertStringV1(
        request.payload,
        decodedToken
      );
  ...
  public getconvertedDataAmount = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.getconvertedDataAmountV1(
        request.payload,
        decodedToken
      );
  ...
  public listSportCategory = async (
    ...
    try {
      ...
      logger.error("Error in listSportCategory", error);
      return response
        .response({
          success: false,
          message:
